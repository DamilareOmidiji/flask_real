...
def video_page(video):
    print (video)
    url = 'http://34.142.107.226/myflix/videos?filter={"video.uuid":"'+video+'"}'
    headers = {}
    payload = json.dumps({ })
...
@app.route('/')
def cat_page():
    url = "http://34.142.107.226/myflix/videos"
    headers = {}
    payload = json.dumps({ })
    ...
    for index in jResp:
       ...
       for key in index:
           ...
           if (key !="_id"):
              ...
              html=html+'<img src="https://storage.googleapis.com/daminetflix/myflixmedia/pics/'+thumb+'">'
              html=html+"</a>"        
              print("=======================")
